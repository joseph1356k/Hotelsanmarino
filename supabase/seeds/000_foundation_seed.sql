...
(
  ...
  'hero',
  'El Morro se vive aqui',
  'Cerca del mar, con atencion directa y una forma mas comoda de quedarte en El Morro.',
  'Descubre una forma mas clara de quedarte en El Morro, con habitaciones bien presentadas y contacto directo con el hotel.',
  '{"eyebrow":"Hotel San Marino","ctaLabel":"Escribir por WhatsApp"}'::jsonb,
  'published',
  1
),
(
  ...
  'Comodidad, capacidad y contexto para encontrar la opcion que mejor te queda.',
...
select
  ...
  'habitacion-' || room_code,
  'Una habitacion comoda para descansar en El Morro y disfrutar la cercania con el mar.',
  'Habitacion ' || room_code || ' pensada para una estadia tranquila, con lo necesario para descansar bien y moverte con facilidad por Tumaco.',
  price_value,
  capacity_value,
  status_value,
  featured_value,
  ...
  'Habitacion ' || room_code || ' en Hotel San Marino Tumaco.'
from room_seed
on conflict (slug) do update set
  name = excluded.name,
...
(
  ...
  'Plan Corporativo',
  'plan-corporativo',
  'Una opcion comoda para viajes de trabajo con atencion directa y una estadia bien resuelta.',
...
(
  ...
  'Plan Escapada',
  'plan-escapada',
  'Una escapada corta para cambiar de ritmo y quedarte cerca del mar.',
...
(
  ...
  'Carlos R.',
  'Pasto',
  'Es una estadia comoda, bien ubicada y facil de resolver desde el primer contacto.',
  4,
  false,
  2,
  'published'
