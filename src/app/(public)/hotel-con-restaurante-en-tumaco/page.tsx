...
const page = localSeoPages["hotel-con-restaurante-en-tumaco"];

export const metadata: Metadata = {
  title: page.title,
  description: page.description,
  keywords: [page.keyword, "hotel en Tumaco", "hotel con restaurante"],
};

export default async function HotelConRestauranteEnTumacoPage() {
