...
const page = localSeoPages["hotel-con-piscina-en-tumaco"];

export const metadata: Metadata = {
  title: page.title,
  description: page.description,
  keywords: [page.keyword, "hotel en Tumaco", "hotel con piscina"],
};

export default async function HotelConPiscinaEnTumacoPage() {
